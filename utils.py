...
class Ordered_list(Queue):
    ...
    def extend(self, items):
        self.A = items + self.A
        self.A = sorted(self.A, key=lambda elem: elem.path_cost, reverse=True)

    def pop(self):
        return self.A.pop()

class Ordered_list_whith_subestimation(Queue):
    ...
    def extend(self, items):
        self.A = items + self.A
        self.A = sorted(self.A, key=lambda elem: elem.path_cost + self.P.h(elem), reverse=True)
